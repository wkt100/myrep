...
#include "HZ_ValveThree.h"
PtWidgetClass_t *CreateHZ_ValveThreeClass(void);

PtWidgetClassRef_t WHZ_ValveThree = {NULL, CreateHZ_ValveThreeClass, 0};
PtWidgetClassRef_t *HZ_ValveThree = &WHZ_ValveThree;


static void HZ_ValveThree_dflts(PtWidget_t *widget )
{
	HZ_ValveThreeWidget *otherone = NULL;
...
PtWidgetClass_t *CreateHZ_ValveThreeClass(void)
{
	static PtResourceRec_t resources[] = {
			{HZ_HEIGHT174, Pt_CHANGE_RESIZE_REDRAW, 0,
			Pt_ARG_IS_NUMBER( HZ_ValveThreeWidget, hz_height ), 0},
			{HZ_WIDTH174, Pt_CHANGE_RESIZE_REDRAW, 0,
			Pt_ARG_IS_NUMBER( HZ_ValveThreeWidget, hz_width ), 0},
			{HZ_ROTATE174, Pt_CHANGE_REDRAW, 0,
			Pt_ARG_IS_NUMBER( HZ_ValveThreeWidget, hz_rotates ), 0},
			{HZ_COLOR174, Pt_CHANGE_REDRAW, 0,
			Pt_ARG_IS_NUMBER( HZ_ValveThreeWidget, hz_color ), 0},
			{HZ_FRAME_COLOR174, Pt_CHANGE_REDRAW, 0,
			Pt_ARG_IS_NUMBER( HZ_ValveThreeWidget, hz_frame_color ), 0},
			{HZ_Q174, Pt_CHANGE_REDRAW, 0,
			Pt_ARG_IS_NUMBER( HZ_ValveThreeWidget, hz_q ), 0},
			};


	static PtArg_t args[] = {
			{ Pt_SET_VERSION, 110, 0},
			{ Pt_SET_STATE_LEN, sizeof(HZ_ValveThreeWidget ), 0},
			{ Pt_SET_DFLTS_F, (long)HZ_ValveThree_dflts, 0 },
			{ Pt_SET_DRAW_F, (long)HZ_ValveThree_draw, 0 },
	...
	return (HZ_ValveThree->wclass = PtCreateWidgetClass(
